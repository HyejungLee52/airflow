from plugins.operators.seoul_api_to_csv_operator import SeouldApiToCsvOperator
...
with DAG(
    ...
    tb_corona19_count_status = SeouldApiToCsvOperator(
        ...
        path='/opt/airflow/files/TbCorona19CountStatus/{{data_interval_end.in_timezoe("Aisa/Seoul") | ds_nodash}}',
    ...
    tb_corona19_vaccine_stat_new = SeouldApiToCsvOperator(
        ...
        path='/opt/airflow/files/tvCorona19VaccinestatNew/{{data_interval_end.in_timezoe("Aisa/Seoul") | ds_nodash}}',
